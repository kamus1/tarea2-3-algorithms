...
bool compilarArchivo() {
    string comando_compilacion = "g++ distancia_edicion_BF_memory.cpp -o distancia_edicion_BF_memory";
...
int main() {
    ...
    if (!compilarArchivo()) {
        cerr << "Error al compilar el archivo distancia_edicion_BF_memory.cpp." << endl;
        return 1;
    }
